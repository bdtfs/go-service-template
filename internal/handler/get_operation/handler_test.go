...
func TestHandle_OK(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/operations/ext-1", nil)
...
func TestHandle_NotFound(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/operations/missing", nil)
...
func TestHandle_MissingExternalID(t *testing.T) {
	...
	h.Handle(rec, httptest.NewRequest(http.MethodGet, "/api/v1/operations/", nil))
